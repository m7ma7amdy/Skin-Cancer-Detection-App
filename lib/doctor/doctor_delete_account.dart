...
class DeleteAccountScreenD extends StatelessWidget {
  final FirebaseAuth _auth = FirebaseAuth.instance;

   DeleteAccountScreenD({super.key});
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: const Text("تم حذف حساب المستخدم بنجاح."),
            actions: <Widget>[
              TextButton(
                onPressed: () {
      ...
      showDialog(
        ...
        builder: (BuildContext context) {
          return AlertDialog(
            ...
            content: Text("حدث خطأ أثناء حذف الحساب: $error"),
            actions: <Widget>[
              TextButton(
                onPressed: () {
                  Navigator.of(context).pop();
