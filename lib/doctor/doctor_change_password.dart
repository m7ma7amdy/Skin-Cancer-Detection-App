...
import 'package:test/doctor/doctor_settings.dart';

import '../spacer.dart';

class ChangePasswordScreenD extends StatefulWidget {
  const ChangePasswordScreenD({super.key});

  @override
  _ChangePasswordScreenDState createState() => _ChangePasswordScreenDState();
}

class _ChangePasswordScreenDState extends State<ChangePasswordScreenD> {
        ...
        leading: IconButton(
          ...
          onPressed: () {
            Navigator.pushReplacement(
              context,
              MaterialPageRoute(builder: (context) => const doctorsettings()),
            );
          },
        ),
      ),
